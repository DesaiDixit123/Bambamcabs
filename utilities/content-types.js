const allowedContentTypes = [
    ...
    { extn: 'rar', mimeType: 'application/octet-stream', fName: 'DOC' },
    ...
    { extn: 'xlsx', mimeType: 'application/vnd.ms-excel', fName: 'DOC' },
...
const imagevideoarray = ['image/webp', 'image/png', 'image/jpeg', 'image/gif', 'image/bmp', 'image/vnd.microsoft.icon', 'image/tiff', 'image/svg+xml', 'video/x-f4v', 'video/x-matroska', 'video/x-msvideo', 'video/mp4', 'video/webm', 'audio/webm', 'video/3gpp', 'audio/3gpp', 'video/3gpp2', 'audio/3gpp2', 'video/x-ms-wmv', 'video/quicktime', 'video/MP2T', 'video/x-flv'];
const allcontentarray = ['image/webp', 'image/png', 'image/jpeg', 'image/gif', 'image/bmp', 'image/vnd.microsoft.icon', 'image/tiff', 'image/svg+xml', 'application/zip', 'text/plain', 'application/vnd.rar', 'application/pdf', 'text/csv',
    'application/msword', 'application/vnd.ms-excel', 'application/vnd.ms-powerpoint',
    'application/x-tar', 'application/vnd.oasis.opendocument.presentation',
    'application/vnd.oasis.opendocument.spreadsheet', 'application/vnd.oasis.opendocument.text',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    'application/vnd.openxmlformats-officedocument.presentationml.presentation',
    'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
    'application/x-7z-compressed', 'application/octet-stream', 'audio/mpeg', 'audio/aac', 'audio/wav', 'audio/opus', 'audio/amr', 'audio/ogg', 'video/x-msvideo', 'video/mp4', 'video/webm', 'audio/webm', 'video/3gpp', 'audio/3gpp', 'video/3gpp2', 'audio/3gpp2', 'video/x-f4v', 'video/x-matroska', 'video/x-msvideo', 'video/mp4', 'video/webm', 'audio/webm', 'video/3gpp', 'audio/3gpp', 'video/3gpp2', 'audio/3gpp2', 'video/x-ms-wmv', 'video/quicktime', 'video/MP2T', 'video/x-flv'];
module.exports = { allowedContentTypes, imagearray, docarray, audiovideoarray, videoarray, imagedocarray, allcontentarray, imagevideoarray };